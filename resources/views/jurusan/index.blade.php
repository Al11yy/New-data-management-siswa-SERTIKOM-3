<x-app-layout>
    <div class="p-6 lg:p-8">
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                <h1 class="text-2xl font-bold text-white">Data Jurusan</h1>
                <p class="text-white/60 text-sm mt-1">Kelola program studi yang tersedia</p>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            @forelse ($jurusans as $item)
                <div class="bg-white/5 border border-white/10 rounded-xl p-5 hover:bg-white/10 transition group">
                    <div class="flex items-start justify-between mb-4">
                        <div class="w-10 h-10 rounded-lg bg-amber-500/10 border border-amber-400/20 flex items-center justify-center">
                    ...
                    <h3 class="text-lg font-semibold text-white mb-2">{{ $item->nama_jurusan }}</h3>
            ...
            @empty
                <div class="md:col-span-2 lg:col-span-3">
                    <div class="bg-white/5 border border-white/10 rounded-xl p-8 text-center">
                        ...
                        <p class="text-white/60 mb-4">Belum ada data jurusan</p>
                        <a href="{{ route('jurusan.create') }}" 
