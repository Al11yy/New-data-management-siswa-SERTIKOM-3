<div class="flex flex-col h-full">
    ...
    <div class="flex items-center gap-4 px-6 h-24 border-b border-white/[0.04]">
        ...
        <div>
            <h1 class="text-white font-bold text-xl tracking-tight">EduData</h1>
            <p class="text-white/35 text-xs font-medium">Sistem Management Siswa</p>
        </div>
    </div>
